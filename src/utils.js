...
module.exports = {
  ...
  makeMentionsMarkup: function(markup, id, display, type, compileMarkup) {
    const compiledMarkup = compileMarkup(markup, { id, display, type });
    let result = compiledMarkup.replace(PLACEHOLDERS.id, id);
